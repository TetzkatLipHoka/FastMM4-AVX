...
{$ENDIF USE_CDECL}
{$IF ( CompilerVersion < 20 ) AND Defined( ZLIB_132 )}
procedure crc32_z; external;
{$IFEND}
{$ENDIF Win64}
...
{$IFDEF GZIP} // errno referenzieren NUR gzread/gzwrite (gemessen ueber alle Saetze)
{$IFDEF ZLIB_132}
var
  __errno: Integer;
{$ELSE}
...
function snprintf(buf: Pointer; nzize: size_t; format: PAnsiChar): Integer; cdecl; varargs; external szMSVCRT name '_snprintf';
...
function read(__handle: Integer; __buf: Pointer; __len: LongWord): Integer; cdecl; external szMSVCRT name '_read';
function write(__handle: Integer; __buf: Pointer; __len: LongWord): Integer; cdecl; external szMSVCRT name '_write';
function close(__handle: Integer): Integer; cdecl; external szMSVCRT name '_close';
